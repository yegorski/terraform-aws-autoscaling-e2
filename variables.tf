...
variable "app_name" {
  type        = "string"
  description = "Used to name and tag AWS resources."
}

variable "app_port" {
  type        = "string"
  description = "Port that the application is using on the server."
}
...
variable "instance_type" {
  type        = "string"
  description = "EC2 instance size. Defaults to `t3.micro`."
  default     = "t3.micro"
}
